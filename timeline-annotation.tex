...
\only<2->{\cite{bethard-etal:2007:IJSC}: linguistically plausible pairs \only<6->{\hfill Agr: 0.90}}}%
...
Hand-constructed grammars \smallcite{StroetgenGertz2013:LREjournal,bethard:2013:EMNLP,lee-EtAl:2014:P14-1}\pause:
